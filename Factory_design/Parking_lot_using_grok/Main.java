package Factory_design.Parking_lot_using_grok;
...
Vehicle Type: HEAVY
  Floor 1:
    ...
    Reserved Spots: 2
-------------------------------
Vehicle ABC123 entered via Gate GATE-1. Spot: CAR-F1-1, Floor: 1, Ticket: TICKET-b30db1e9
----- Parking Availability -----
Vehicle Type: BIKE
  Floor 1:
    Regular Spots: 100
...
Vehicle Type: HEAVY
  Floor 1:
    ...
    Reserved Spots: 2
-------------------------------
Vehicle XYZ789 entered via Gate GATE-2. Spot: BIKE-F1-1, Floor: 1, Ticket: TICKET-98f1ac58
----- Parking Availability -----
Vehicle Type: BIKE
  Floor 1:
    Regular Spots: 99
...
Vehicle Type: HEAVY
  Floor 1:
    ...
    Reserved Spots: 2
-------------------------------
Vehicle HEV456 entered via Gate GATE-1. Spot: HEAVY-F1-3, Floor: 1, Ticket: TICKET-18ece89f
----- Parking Availability -----
Vehicle Type: BIKE
  Floor 1:
    Regular Spots: 100
